package com.zqh.bigdata.zookeeper.dist.ha;
...
import com.zqh.bigdata.zookeeper.dist.Constant;

/**
 * 模拟Zookeeper实现单点故障 自动切换
 * @author 秦东亮  http://qindongliang1922.iteye.com/blog/1985787
 */
public class Slave3 implements Watcher {

	private static final String slave = "node-C";
	private static final String DATA = "c";
	
	public static void main(String[] args) throws Exception {
		Slave3 s = new Slave3(Constant.host);
		s.createTemp();
		s.check();
