...
public class KafkaSourceTest {
    ...
    public void setUp() throws Exception {
        ...
        // custom config
        this.context.put(KafkaFlumeConstans.CUSTOM_TOPIC_KEY_NAME, JunitConstans.TOPIC_NAME);
        this.context.put(KafkaFlumeConstans.DEFAULT_ENCODING, "UTF-8");
        this.context.put(KafkaFlumeConstans.CUSTOM_CONSUMER_THREAD_COUNT_KEY_NAME, "4");
    ...
    private void sendMessageToKafka() {
        ...
        parameters.put("partitioner.class", JunitConstans.PARTITION_CLASS);
